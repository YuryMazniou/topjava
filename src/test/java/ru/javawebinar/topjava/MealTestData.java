...
public class MealTestData {
    ...
    public static void assertMatchMealToList(Iterable<MealTo> actual, Iterable<MealTo> expected) {
        assertThat(actual).usingFieldByFieldElementComparator().isEqualTo(expected);
    }

    public static ResultMatcher contentJson(MealTo... expected) {
        return result -> assertMatchMealToList(readListFromJsonMvcResult(result, MealTo.class), List.of(expected));
    }
